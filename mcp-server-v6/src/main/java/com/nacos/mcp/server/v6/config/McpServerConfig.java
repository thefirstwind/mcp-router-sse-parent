...
import com.nacos.mcp.server.v6.tools.PersonManagementTool;
...
public class McpServerConfig {
    ...
    /**
     * 注释掉原来的路由函数，使用 WebFluxConfig 中的自定义路由
     * 因为 WebFluxSseServerTransportProvider.getRouterFunction() 可能存在注册问题
     */
     @Bean
